...
-- Insert restaurant user (password: RestaurantPass123!)
INSERT INTO users (name, email, password, role, organization_name, address, phone, is_verified, created_at)
VALUES (
  'Pizza Palace',
  'pizza@test.com',
...
VALUES (2, 'Restaurant', 'Italian', 100, NOW());
...
VALUES 
(2, 'Fresh Bread Loaves', 'Whole wheat bread baked this morning', 20, 'loaves', 'Room Temperature', 'Bread', 'Fresh', '2026-02-21 08:00:00', 'AVAILABLE', NOW()),
(2, 'Leftover Pizza Slices', 'Margherita and pepperoni from lunch service', 30, 'pieces', 'Refrigerated', 'Others', 'Fresh', '2026-02-21 12:00:00', 'AVAILABLE', NOW()),
(2, 'Rice Trays', 'Steamed white rice, ready for pickup', 5, 'trays', 'Room Temperature', 'Rice', 'Fresh', '2026-02-21 10:00:00', 'AVAILABLE', NOW());
