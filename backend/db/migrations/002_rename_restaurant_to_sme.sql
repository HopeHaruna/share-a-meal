...
ALTER TABLE users MODIFY COLUMN role ENUM('restaurant', 'ngo', 'sponsor', 'admin', 'sme') NOT NULL;
...
ALTER TABLE users MODIFY COLUMN role ENUM('sme', 'ngo', 'sponsor', 'admin') NOT NULL;
